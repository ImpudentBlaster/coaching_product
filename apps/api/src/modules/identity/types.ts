...
export type ClientInvitation = {
  id: string; coachId: string; email: string; tokenHash: string;
  expiresAt: string; usedAt: string | null; revokedAt: string | null; createdAt: string;
};
...
export type CoachClient = {
  id: string; coachId: string; clientId: string; status: ApprovalStatus;
  rejectionReason: string | null; createdAt: string;
};

export type ClientRelationshipView = CoachClient & { client: PublicUser };

export type RefreshSession = {
  id: string; userId: string; familyId: string; tokenHash: string;
  expiresAt: string; rotatedAt: string | null; revokedAt: string | null;
};
